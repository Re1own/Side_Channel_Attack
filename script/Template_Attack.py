...
def Build_Template_Single_Byte(attack_index, tempTraces, tempPText, tempKey):
    sbox = (
...
def Template_Attack_single_byte(meanMatrix, covMatrix, atkTraces, atkcnt, atkPText, attack_index):
    P_k = np.zeros(256)
    for j in range(atkcnt):
        ...
        for k in range(256):
            ...
            HW = hw[sbox[atkPText[j][attack_index] ^ k]]
        ...
        # print(str(P_k[43]) + '   vs    ' + str(P_k[61]))
        return P_k.argsort()
