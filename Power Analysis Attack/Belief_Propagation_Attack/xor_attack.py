...
#     traces = np.load("..\\..\\Traces\\Xor_50000_fixed_key\\traces.npy")
#     traces = map_to_0_255(traces)
#     traces = traces[start:l]
#     plaintext = np.load("..\\..\\Traces\\Xor_50000_fixed_key\\p.npy")
#     plaintext = plaintext.astype(np.uint16)
#     plaintext = plaintext[start:l]
#     key =np.load("..\\..\\Traces\\Xor_50000_fixed_key\\k.npy")
...
def get_traces(settings, start, l):
    ...
    #!!!!
    traces = np.load("E:\\side_channel_attack\\Power Analysis Attack\\Belief_Propagation_Attack\\sample\\traces.npy")
    labels = load_dict("E:\\side_channel_attack\\Power Analysis Attack\\Belief_Propagation_Attack\\sample\\labels.pkl")
