...
HD_PWD='D:/myhub/Side_Channel_Attack/chipwhisperer/fpga/Xor_Operation/Xor_Operation.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ss2_aes_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ss2_aes_wrapper.tcl
